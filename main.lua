...
function love.load()
    ...
    -- 7. 'pause' (pause menu that can be accessed during play state)
    -- 8. 'high-scores' (high-scores state)
    gStateMachine = StateMachine {
        ...
        ['high-scores-enter'] = function() return EnterHighScoreState end
    }

    -- load high scores from Util.lua
    highScores = loadHighScores()

    -- settings variables
    gSound = true -- master sound flag (ON -- default)
    gMusic = true -- game music flag (ON -- default)
    gEffectSound = true -- sound effects flag (ON -- default)
